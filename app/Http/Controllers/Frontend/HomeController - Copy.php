    ...
    public function dashboard(){
        try{
            ...
            $relations = \DB::table('applications')
                    ...
                    ->select('applications.status', 'services.name', 'services.image', 'applications.ref_id', 'applications.created_at')->where('applications.user_id', $user_id)->orderBy('applications.id', 'desc')->get();
